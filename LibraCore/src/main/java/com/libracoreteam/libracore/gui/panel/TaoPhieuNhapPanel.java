...
public class TaoPhieuNhapPanel extends JPanel {
    ...
    private JButton btnLuuPhiếu;

    public TaoPhieuNhapPanel() {
        initComponents();
        setupLayout();
    }
    ...
    private void initComponents() {
        ...
        btnLuuPhiếu = new JButton("Lưu Phiếu Nhập");
        btnLuuPhiếu.setFont(btnLuuPhiếu.getFont().deriveFont(Font.BOLD, 14f));
        btnLuuPhiếu.setBackground(new Color(40, 167, 69));
        btnLuuPhiếu.setForeground(Color.WHITE);
    }

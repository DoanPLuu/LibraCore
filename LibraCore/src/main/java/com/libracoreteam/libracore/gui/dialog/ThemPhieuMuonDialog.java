...
public class ThemPhieuMuonDialog extends JDialog {
    ...
    public ThemPhieuMuonDialog(Frame parent) {
        ...
        loadAllCardsToMemory(); // Tải danh sách thẻ vào RAM trước
        initUI();
        loadCuonSach();
        pack();
    ...
    private void initUI() {
        ...
        editor.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                ...
                if (code == KeyEvent.VK_UP || code == KeyEvent.VK_DOWN || code == KeyEvent.VK_LEFT || code == KeyEvent.VK_RIGHT || code == KeyEvent.VK_ENTER) {
                    return;
                }
        ...
        for (CardItem item : allCardItems) cbxIdThe.addItem(item);
    ...
    private void onThem() {
        if (validIdThe == -1) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập và bấm 'Kiểm tra' để xác nhận thẻ hợp lệ!", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
            return;
        }  
